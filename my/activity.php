...
<html class="no-js">
    ...
    <head>
        <title>Transaction History-PiggyBank</title>
...
// Display search result
         if (!$query->rowCount() == 0) {
                ...
                echo "<tr><th>Time</th><th>Sender</th><th>Recipient</th><th>Amount</th><th>Content</th></tr>";
            while ($results = $query->fetch()) {
                ...
                echo "".date("d-m-Y", strtotime($results['date']));
                                ...
                                {
                                        echo "".$user_activity->emailtoname($results['fromEmail']);
                                        echo "</td><td>";
                                }
            ...
            echo "<h3>No transactions during this time! </br>Do you want to buy something? Check out PiggyBank's promotions</h3>";
        }
        ?>
